...
public class NoteActivity extends AppCompatActivity {
    public static final String NOTE_POSITION = "com.android.example.notekeeper.NOTE_POSITION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mViewModel.mIsNewlyCreated == true && savedInstanceState != null)
    ...
    private void storePreviousNoteValues() {
        CourseInfo course = DataManager.getInstance().getCourse(mViewModel.mOriginalNoteCouseId);
    ...
    private void readDisplayStateValue() {
        ...
        if (mIsNewNote) {
            ...
            mNote = DataManager.getInstance().getNotes().get(this.position);
        }
    }
